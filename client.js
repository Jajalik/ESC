...
Damage.GetContext().DamageOut.Value = G

NameMode.Parameters.GetBool("Damage");
...
Players.Get("38E4EDF7E09CF5C").build.BuildRangeEnable.Value = true;

Players.Get("38E4EDF7E09CF5C"). Damage.DamageIn.Value = false;
